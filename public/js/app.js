const LOCAL_STORAGE_CODE_SETTINGS_KEY = "codeSettings";
...
const saveSettings = () => {
  let storedSettings = localStorage.getItem(LOCAL_STORAGE_CODE_SETTINGS_KEY);
  ...
  if (storedSettings !== currentSettings) {
    localStorage.setItem(LOCAL_STORAGE_CODE_SETTINGS_KEY, currentSettings);
  }
};
